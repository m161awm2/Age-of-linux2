...
export const UNITS: Record<UnitKind, UnitDefinition> = {
  ...
  fireArcher: unit({ kind: 'fireArcher', name: '불화살 사수', symbol: 'F', family: 'archer', tier: 1, texture: 'fireArcher', hp: 11, damage: 6, originalDamage: 6, cost: 7, rangeTiles: 5, attackInterval: 2, originalAttackInterval: 2, ranged: true, speedMultiplier: 1, description: '0.5초마다 최대 HP 5% 화상 피해를 3회 적용하며 중첩 가능' }),
  ...
  wingedHussar: unit({ kind: 'wingedHussar', name: '윙드 후사르', symbol: 'W', family: 'cavalry', tier: 1, texture: 'wingedHussar', hp: 27, damage: 9, originalDamage: 9, cost: 13, rangeTiles: 2, attackInterval: 1.2, originalAttackInterval: 1.2, ranged: false, speedMultiplier: 1.8, description: '8칸 돌진 시 2.4배속, 첫 충돌 피해 최대 50%' }),
  ...
  sanada: unit({ kind: 'sanada', name: '사나다 사무라이', symbol: 'Y', family: 'special', tier: 2, texture: 'sanada', hp: 60, damage: 22, originalDamage: 18, cost: 45, rangeTiles: 1, attackInterval: .9, originalAttackInterval: .75, ranged: false, speedMultiplier: 1.8, description: '8칸 돌진 시 첫 충돌 피해 최대 50%와 2초 패링', eliteCooldown: 35 }),
};

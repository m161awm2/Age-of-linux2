...
export const UNITS: Record<UnitKind, UnitDefinition> = {
  ...
  spearman: unit({ kind: 'spearman', name: '창병', symbol: 'S', family: 'infantry', tier: 1, texture: 'spearman', hp: 16, damage: 7, originalDamage: 7, cost: 4, rangeTiles: 2, attackInterval: 1.1, originalAttackInterval: 1.1, ranged: false, speedMultiplier: 1, description: '기병에게 1.8배 피해와 첫 돌격 반격' }),
  halberd: unit({ kind: 'halberd', name: '할버드', symbol: 'H', family: 'infantry', tier: 2, texture: 'halberd', hp: 18, damage: 8, originalDamage: 8, cost: 6, rangeTiles: 2, attackInterval: 1, originalAttackInterval: 1, ranged: false, speedMultiplier: 1, description: '기병 1.8배 + 최대 HP 12% 추가 피해' }),
  ...
  shieldGuard: unit({ kind: 'shieldGuard', name: '방패병', symbol: 'G', family: 'infantry', tier: 2, texture: 'shieldGuard', hp: 33, damage: 5, originalDamage: 5, cost: 6, rangeTiles: 1, attackInterval: 1, originalAttackInterval: 1, ranged: false, speedMultiplier: 1, description: '8 방패로 한 번의 공격을 완전히 흡수' }),
